function CCongratulations(aResults, iScore) {
    ...
    this._init = function (aResults, iScore) {
        ...
        _oTitle = new CTLText(s_oStage, 
                    CANVAS_WIDTH / 2-oSpriteMsgBox.width/2+20, CANVAS_HEIGHT * 0.5 - 210, oSpriteMsgBox.width-40, 72, 
                    36, "center", TEXT_COLOR, FONT_GAME, 1,
                    0, 0,
                    TEXT_CONGRATULATIONS,
                    true, true, true,
                    false );
         _oTitle.setStroke(5,"#ff6000");        
        ...
        _oScore = new CTLText(s_oStage, 
                    CANVAS_WIDTH / 2-oSpriteMsgBox.width/2+20, CANVAS_HEIGHT * 0.5 + oInfo.offsetY, oSpriteMsgBox.width-40, 30, 
                    30, "center", TEXT_COLOR, FONT_GAME, 1,
                    0, 0,
                    TEXT_TOTAL_SCORE + ": " + iScore,
                    true, true, false,
                    false );
        _oScore.setStroke(5,"#ff6000")            
